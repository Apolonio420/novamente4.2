...
export const CATALOG_PRODUCTS: CatalogProduct[] = [
    ...
    colors: [
      {
        ...
        hero: '/products/musculosa-bali-blanca/front.png',
      },
      {
        key: 'gray',
        name: 'Gris',
        ...
        hero: '/products/musculosa-bali-gris/front.png',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    measurementsImage: '/products/remera-infantil-medidas.png',
    shortDescription: 'Remera infantil unisex en algodon 100% peinado, talles del 4 al 16. La misma calidad Novamente en version kids.',
    // Los keys de color son los slugs de los assets /garments/remera-infantil-<key>-<side>.jpeg
    colors: [
      {
        key: 'white',
        name: 'Blanco',
        hex: '#f5f5f5',
        thumbnail: '/garments/remera-infantil-white-front.jpeg',
        hero: '/products/remera-infantil-blanco/front.jpg',
      },
      {
        key: 'black',
        name: 'Negro',
        hex: '#1a1a1a',
        thumbnail: '/garments/remera-infantil-black-front.jpeg',
        hero: '/products/remera-infantil-negro/front.jpg',
      },
      {
        key: 'gray',
        name: 'Gris',
        hex: '#9a9a9a',
        thumbnail: '/garments/remera-infantil-gray-front.jpeg',
        hero: '/products/remera-infantil-gris/front.jpg',
      },
      {
        key: 'yellow',
        name: 'Amarillo',
        hex: '#f3d34a',
        thumbnail: '/garments/remera-infantil-yellow-front.jpeg',
        hero: '/products/remera-infantil-amarillo/front.jpg',
      },
      {
        key: 'celeste',
        name: 'Celeste',
        hex: '#a5c9e8',
        thumbnail: '/garments/remera-infantil-celeste-front.jpeg',
        hero: '/products/remera-infantil-celeste/front.jpg',
      },
      {
        key: 'rosa',
        name: 'Rosa',
        hex: '#f4b8c5',
        thumbnail: '/garments/remera-infantil-rosa-front.jpeg',
        hero: '/products/remera-infantil-rosa/front.jpg',
      },
    ],
  },
  {
