...
export const CATALOG_PRODUCTS: CatalogProduct[] = [
  ...
  },
  {
    ...
    colors: [
      ...
      },
      {
        ...
        name: 'Caramel',
        hex: '#B8825A',
        thumbnail: '/garments/tshirt-caramel-oversize-front.png',
        hero: '/products/aura-tshirt-caramel-front.jpeg',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    garmentType: 'canvas',
    fit: 'n/a',
    fabric: 'lienzo textil premium',
    weightGsm: null,
    costARS: 15000,
    retailARS: 59900,
    sizes: ['15x10cm', '30x20cm', '40x35cm'],
    measurementsImage: null,
    shortDescription: 'Lienzo textil premium para impresion de arte. Ideal para decoracion.',
    colors: [
      {
        key: 'white',
        name: 'Lienzo Base',
        hex: '#ffffff',
        thumbnail: '/garments/lienzo-main.png',
        hero: '/products/lienzo-main.png',
      },
    ],
  },
]
