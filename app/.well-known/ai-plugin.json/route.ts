...
export async function GET() {
  return NextResponse.json({
    ...
    description_for_model:
      'Novamente is an Argentine AI-powered custom apparel platform. Users can design t-shirts, hoodies, and tote bags using 37 artistic styles and DTG printing. Ships nationwide in Argentina. Prices in ARS. Products: Aldea Classic Fit ($28,600), Aura Oversize ($29,900), Hoodie Esencial ($52,500), Astra Tote Bag ($18,600). Also offers a B2B partner program for brands to create and sell their own merch.',
    auth: { type: 'none' },
    api: {
      type: 'openapi',
