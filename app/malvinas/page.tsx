...
const DESIGNS: MalvinasDesign[] = [
  {
    ...
    waText:
      "Hola Novamente! Quiero la remera oversize de la Serie Malvinas (el trapo sobre negra). Me pasan info? (ref · NV-MALVINAS)",
  ...
  },
  {
    ...
    waText:
      "Hola Novamente! Quiero la remera oversize de la Serie Malvinas (la frase sobre negra). Me pasan info? (ref · NV-MALVINAS)",
  ...
  },
  {
    ...
    waText:
      "Hola Novamente! Quiero la remera clásica de la Serie Malvinas (la frase sobre blanca). Me pasan info? (ref · NV-MALVINAS)",
