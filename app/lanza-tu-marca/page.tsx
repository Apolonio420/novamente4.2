...
export default function LanzaTuMarca() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "El plan Starter es 100% gratis: tenes tienda online, diseno con IA, y produccion on-demand sin costo fijo. Solo pagas cuando vendes. El plan Growth ($25 USD/mes) agrega dominio propio, analytics y mas. El plan Pro ($100 USD/mes) incluye todo + prioridad de produccion y soporte dedicado.",
        },
      },
      {
        "@type": "Question",
  ...
  const plans = [
    ...
    },
    {
      name: "Growth",
      price: "$25 USD/mes",
      priceDetail: "Dominio propio + analytics",
      features: [
        "Todo lo de Starter +",
        "Dominio personalizado",
        "Analytics y metricas",
        "Prioridad media de produccion",
        "Soporte prioritario",
      ],
      cta: "Elegir Growth",
      highlighted: true,
    },
    {
      name: "Pro",
      price: "$100 USD/mes",
      priceDetail: "Para marcas en serio",
      features: [
        "Todo lo de Growth +",
        "Prioridad alta de produccion",
        "Soporte dedicado",
        "API de integracion",
        "Consultas de branding 1-a-1",
      ],
      cta: "Elegir Pro",
      highlighted: false,
    },
