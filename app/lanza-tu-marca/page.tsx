    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "El plan Starter es 100% gratis: tenes tienda online, diseno con IA, y produccion on-demand sin costo fijo. Solo pagas cuando vendes (prendas a precio partner B2B). El plan Growth (USD$50/mes, -15% en plan anual) suma SEO completo, analytics, generaciones de IA ilimitadas y prendas a un precio aun mas competitivo para que tu margen sea mucho mayor. El plan Pro (USD$100/mes, -15% en plan anual) suma chatbot WhatsApp + Instagram, automatizacion de contenido IG/FB/X, Meta Ads y onboarding 1:1.",
        },
      },
      {
        "@type": "Question",
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Generaciones de IA ilimitadas (mockups + estilos)",
