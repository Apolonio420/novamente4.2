  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Los hoodies comienzan en $55.000 ARS para el Buzo Hoodie Oversize. Disponibles en negro, blanco, marron, crema, gris melange y stone wash. Incluyen diseño con IA y estampado DTG.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Hay 3 planes: Starter (gratis, hasta 10 productos y 20 leads/mes, prendas a precio retail). Growth (USD$50/mes, productos ilimitados, SEO completo, Design Engine, analytics y prendas a costo + $1.000 ARS). Pro (USD$100/mes, todo lo de Growth + chatbot WhatsApp/Instagram, automatización de contenido para IG/FB/X, Meta Ads, onboarding 1:1).",
      },
      {
